...
To use these stylesheets, rename the files and irlandwatch with the name of your theme.
...
irlandwatch-alpha-default-narrow.css  
...
irlandwatch-alpha-default-normal.css
...
irlandwatch-alpha-default-wide.css
